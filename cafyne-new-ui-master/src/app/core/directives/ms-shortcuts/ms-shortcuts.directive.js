(function () {
	...
	function MsShortcutsController($scope, $cookies, $document, $timeout, $q, msNavigationService) {
		...
		function loadShortcuts() {
			...
			var shortcuts = angular.fromJson($cookies.get('CAFYNE.shortcuts'));
			...
			if (angular.isUndefined(shortcuts)) {
				...
				$cookies.put('CAFYNE.shortcuts', angular.toJson(shortcuts));
			}
		...
		function saveShortcuts() {
			...
			$cookies.put('CAFYNE.shortcuts', angular.toJson(vm.shortcuts));
